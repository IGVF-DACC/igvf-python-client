...
class PseudobulkSet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["is_on_anvil", "doi", "input_file_sets", "release_timestamp", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "supersedes", "cell_type", "cell_qualifier", "merged", "@id", "@type", "summary", "files", "control_for", "superseded_by", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "cell_annotation", "workflows", "preferred_assay_titles", "preferred_assay_slims", "assay_titles", "assay_slims"]
