...
class SequenceFile(BaseModel):
    ...
    def read_names_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['Read 1', 'Read 2', 'Barcode index']):
                raise ValueError("each list item must be one of ('Read 1', 'Read 2', 'Barcode index')")
        return value
