...
class ReferenceFile(BaseModel):
    ...
    def assembly_validate_enum(cls, value):
        ...
        if value not in set(['GRCh38', 'hg19', 'Cast - GRCm39', 'GRCm39', 'mm10', 'custom']):
            raise ValueError("must be one of enum values ('GRCh38', 'hg19', 'Cast - GRCm39', 'GRCm39', 'mm10', 'custom')")
        return value
