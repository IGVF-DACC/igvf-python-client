...
class ReferenceFile(BaseModel):
    ...
    def catalog_method_validate_enum(cls, value):
        ...
        if value not in set(['ADASTRA', 'caQTL', 'COXPRESdb', 'eQTL', 'GWAS', 'GVATdb', 'pQTL', 'splice_QTL']):
            raise ValueError("must be one of enum values ('ADASTRA', 'caQTL', 'COXPRESdb', 'eQTL', 'GWAS', 'GVATdb', 'pQTL', 'splice_QTL')")
        return value
