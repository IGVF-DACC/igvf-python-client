...
class Software(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["source_url", "release_timestamp", "publications", "lab", "award", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "name", "title", "used_by", "categories", "@id", "@type", "summary", "versions"]
