...
class AnalysisStep(BaseModel):
    ...
    def analysis_step_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['alignment', 'barcode mapping generation', 'counts normalization', 'file format conversion', 'filtering', 'interaction calling', 'merging', 'peak calling', 'quantification', 'signal generation', 'signal normalization', 'spatial feature detection', 'variant annotation']):
                raise ValueError("each list item must be one of ('alignment', 'barcode mapping generation', 'counts normalization', 'file format conversion', 'filtering', 'interaction calling', 'merging', 'peak calling', 'quantification', 'signal generation', 'signal normalization', 'spatial feature detection', 'variant annotation')")
        return value
