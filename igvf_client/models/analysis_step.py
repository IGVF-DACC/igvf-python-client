...
class AnalysisStep(BaseModel):
    ...
    def analysis_step_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['alignment', 'barcode counting', 'barcode mapping generation', 'base calling', 'cell to feature barcode mapping', 'counts normalization', 'demultiplexing', 'differential expression analysis', 'fastq concatenation', 'file format conversion', 'filtering', 'fragment generation', 'interaction calling', 'matrix generation', 'merging', 'peak calling', 'read trimming', 'quantification', 'signal generation', 'signal normalization', 'spatial feature detection', 'UMI deduplication', 'UMI quantification', 'variant annotation']):
