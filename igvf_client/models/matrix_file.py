...
class MatrixFile(BaseModel):
    ...
    def file_format_validate_enum(cls, value):
        ...
        if value not in set(['h5ad', 'hdf5', 'mtx', 'tar', 'hic', 'cool', 'mcool']):
            raise ValueError("must be one of enum values ('h5ad', 'hdf5', 'mtx', 'tar', 'hic', 'cool', 'mcool')")
        return value
    ...
    def secondary_dimensions_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['antibody capture', 'cell', 'CRISPR guide capture', 'fragment', 'gene', 'gene expression', 'genomic position', 'peak', 'time', 'treatment', 'variant']):
                raise ValueError("each list item must be one of ('antibody capture', 'cell', 'CRISPR guide capture', 'fragment', 'gene', 'gene expression', 'genomic position', 'peak', 'time', 'treatment', 'variant')")
        return value
