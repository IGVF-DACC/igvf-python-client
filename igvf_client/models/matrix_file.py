...
class MatrixFile(BaseModel):
    ...
    def secondary_dimensions_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['antibody capture', 'cell', 'CRISPR guide capture', 'fragment', 'gene', 'gene expression', 'genomic position', 'peak', 'time', 'treatment', 'UMI count', 'variant']):
                raise ValueError("each list item must be one of ('antibody capture', 'cell', 'CRISPR guide capture', 'fragment', 'gene', 'gene expression', 'genomic position', 'peak', 'time', 'treatment', 'UMI count', 'variant')")
        return value
