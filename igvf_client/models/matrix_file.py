...
"""
    ...
    The version of the OpenAPI document: 56.0.1
...
class MatrixFile(BaseModel):
    ...
    def secondary_dimensions_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['antibody capture', 'cell', 'CRISPR guide capture', 'fragment', 'gene', 'gene expression', 'genomic position', 'time', 'treatment', 'variant']):
                raise ValueError("each list item must be one of ('antibody capture', 'cell', 'CRISPR guide capture', 'fragment', 'gene', 'gene expression', 'genomic position', 'time', 'treatment', 'variant')")
        return value
