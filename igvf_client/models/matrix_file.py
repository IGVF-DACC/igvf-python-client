...
class MatrixFile(BaseModel):
    ...
    def principal_dimension_validate_enum(cls, value):
        ...
        if value not in set(['cell', 'fragment', 'gene', 'mitochondrial variants', 'time', 'treatment', 'variant', 'genomic position', 'spot barcode']):
            raise ValueError("must be one of enum values ('cell', 'fragment', 'gene', 'mitochondrial variants', 'time', 'treatment', 'variant', 'genomic position', 'spot barcode')")
        return value
