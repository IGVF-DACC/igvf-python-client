...
class MatrixFile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "reference_files", "filtered", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "analysis_step_version", "content_md5sum", "content_type", "dbxrefs", "derived_from", "derived_manually", "file_format", "file_format_specifications", "file_set", "file_size", "md5sum", "submitted_file_name", "upload_status", "validation_error_detail", "checkfiles_version", "principal_dimension", "secondary_dimensions", "@id", "@type", "summary", "integrated_in", "input_file_for", "gene_list_for", "loci_list_for", "quality_metrics", "assay_titles", "preferred_assay_titles", "workflow", "href", "s3_uri", "upload_credentials", "content_summary", "transcriptome_annotation", "assembly"]
    ...
    def file_format_validate_enum(cls, value):
        ...
        if value not in set(['h5ad', 'hdf5', 'mtx', 'pkl', 'rds', 'Robj', 'tar', 'hic', 'cool', 'mcool']):
            raise ValueError("must be one of enum values ('h5ad', 'hdf5', 'mtx', 'pkl', 'rds', 'Robj', 'tar', 'hic', 'cool', 'mcool')")
        return value
    ...
    def principal_dimension_validate_enum(cls, value):
        ...
        if value not in set(['cell', 'fragment', 'gene', 'time', 'treatment', 'variant', 'genomic position', 'spot barcode']):
            raise ValueError("must be one of enum values ('cell', 'fragment', 'gene', 'time', 'treatment', 'variant', 'genomic position', 'spot barcode')")
        return value
    ...
    def assembly_validate_enum(cls, value):
        ...
        if value not in set(['GRCh38', 'hg19', 'Cast - GRCm39', 'GRCm39', 'mm10', 'GRCh38, mm10', 'custom', 'Mixed genome assemblies']):
            raise ValueError("must be one of enum values ('GRCh38', 'hg19', 'Cast - GRCm39', 'GRCm39', 'mm10', 'GRCh38, mm10', 'custom', 'Mixed genome assemblies')")
        return value
