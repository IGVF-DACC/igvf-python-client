...
class Workflow(BaseModel):
    ...
    def source_url_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^https?:\/\/(github\.com\/\S+|support\.parsebiosciences\.com\/\S*|www\.10xgenomics\.com\/\S*)$", value):
            raise ValueError(r"must validate the regular expression /^https?:\/\/(github\.com\/\S+|support\.parsebiosciences\.com\/\S*|www\.10xgenomics\.com\/\S*)$/")
        return value
