...
class SoftwareVersion(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "source_url", "release_timestamp", "publications", "lab", "award", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "software", "version", "download_id", "@id", "@type", "summary", "name"]
