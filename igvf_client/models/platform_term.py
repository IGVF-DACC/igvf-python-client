...
class PlatformTerm(BaseModel):
    ...
    def company_validate_enum(cls, value):
        ...
        if value not in set(['10X Genomics', 'Illumina', 'Life Technologies', 'Oxford Nanopore Technologies', 'Pacific Biosciences', 'Parse Biosciences', 'Roche', 'Singular Genomics']):
            raise ValueError("must be one of enum values ('10X Genomics', 'Illumina', 'Life Technologies', 'Oxford Nanopore Technologies', 'Pacific Biosciences', 'Parse Biosciences', 'Roche', 'Singular Genomics')")
        return value
