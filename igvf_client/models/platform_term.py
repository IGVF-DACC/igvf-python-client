...
class PlatformTerm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["release_timestamp", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "term_id", "term_name", "deprecated_ntr_terms", "is_a", "company", "sequencing_kits", "@id", "@type", "summary", "name", "definition", "comments", "synonyms", "ancestors", "ontology"]
