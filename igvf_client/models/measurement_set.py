...
class MeasurementSet(BaseModel):
    ...
    def strand_specificity_validate_enum(cls, value):
        ...
        if value not in set(['5' to 3'', '3' to 5'', 'unstranded']):
            raise ValueError("must be one of enum values ('5' to 3'', '3' to 5'', 'unstranded')")
        return value
