...
class MeasurementSet(BaseModel):
    ...
    def control_type_validate_enum(cls, value):
        ...
        if value not in set(['baseline', 'reference transduction', 'low FACS signal', 'non-targeting', 'unsorted FACS input', 'untransfected', 'untreated']):
            raise ValueError("must be one of enum values ('baseline', 'reference transduction', 'low FACS signal', 'non-targeting', 'unsorted FACS input', 'untransfected', 'untreated')")
        return value
