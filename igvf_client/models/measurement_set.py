...
class MeasurementSet(BaseModel):
    ...
    def control_type_validate_enum(cls, value):
        ...
        if value not in set(['baseline', 'control transduction', 'low FACS signal', 'non-targeting', 'pre-selection', 'unsorted FACS input', 'untransfected', 'untreated']):
            raise ValueError("must be one of enum values ('baseline', 'control transduction', 'low FACS signal', 'non-targeting', 'pre-selection', 'unsorted FACS input', 'untransfected', 'untreated')")
        return value
