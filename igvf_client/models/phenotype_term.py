...
class PhenotypeTerm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["release_timestamp", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "term_id", "term_name", "definition", "comment", "deprecated_ntr_terms", "is_a", "@id", "@type", "summary", "name", "synonyms", "ancestors", "ontology"]
