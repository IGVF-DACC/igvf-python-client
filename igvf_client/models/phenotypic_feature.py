...
class PhenotypicFeature(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["release_timestamp", "status", "lab", "award", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "feature", "quantity", "quantity_units", "quality", "observation_date", "@id", "@type", "summary"]
    ...
    def quantity_units_validate_enum(cls, value):
        ...
        if value not in set(['meter', 'micromole', 'nanogram', 'microgram', 'milligram', 'gram', 'kilogram', 'milli-International Unit per milliliter', 'picogram per milliliter', 'nanogram per milliliter', 'milligram per deciliter', 'UPDRS', 'MMSE']):
            raise ValueError("must be one of enum values ('meter', 'micromole', 'nanogram', 'microgram', 'milligram', 'gram', 'kilogram', 'milli-International Unit per milliliter', 'picogram per milliliter', 'nanogram per milliliter', 'milligram per deciliter', 'UPDRS', 'MMSE')")
        return value
    ...
    def quality_validate_enum(cls, value):
        ...
        if value not in set(['none', 'sparse', 'moderate', 'frequent', 'unknown', 'I', 'II', 'III', 'IV', 'V', 'VI', '2/2', '2/3', '2/4', '3/3', '3/4', '4/4']):
            raise ValueError("must be one of enum values ('none', 'sparse', 'moderate', 'frequent', 'unknown', 'I', 'II', 'III', 'IV', 'V', 'VI', '2/2', '2/3', '2/4', '3/3', '3/4', '4/4')")
        return value
