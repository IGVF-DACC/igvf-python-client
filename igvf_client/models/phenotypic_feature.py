...
class PhenotypicFeature(BaseModel):
    ...
    def quantity_units_validate_enum(cls, value):
        ...
        if value not in set(['meter', 'micromole', 'nanogram', 'microgram', 'milligram', 'gram', 'kilogram', 'milli-International Unit per milliliter', 'picogram per milliliter', 'nanogram per milliliter', 'milligram per deciliter', 'UPDRS', 'MMSE', 'SLEDAI']):
            raise ValueError("must be one of enum values ('meter', 'micromole', 'nanogram', 'microgram', 'milligram', 'gram', 'kilogram', 'milli-International Unit per milliliter', 'picogram per milliliter', 'nanogram per milliliter', 'milligram per deciliter', 'UPDRS', 'MMSE', 'SLEDAI')")
        return value
