...
class AuxiliarySet(BaseModel):
    ...
    def file_set_type_validate_enum(cls, value):
        ...
        if value not in set(['cell hashing barcode sequencing', 'cell sorting', 'circularized RNA barcode detection', 'gRNA sequencing', 'lipid-conjugated oligo sequencing', 'MORF barcode sequencing', 'quantification DNA barcode sequencing', 'variant sequencing']):
            raise ValueError("must be one of enum values ('cell hashing barcode sequencing', 'cell sorting', 'circularized RNA barcode detection', 'gRNA sequencing', 'lipid-conjugated oligo sequencing', 'MORF barcode sequencing', 'quantification DNA barcode sequencing', 'variant sequencing')")
        return value
