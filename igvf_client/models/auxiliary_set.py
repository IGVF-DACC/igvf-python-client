...
class AuxiliarySet(BaseModel):
    ...
    crispr_readout: Optional[StrictStr] = Field(default=None, description="For auxiliary sets linked to CRISPR screen measurement sets, equivalent to file set type.")
    ...
    __properties: ClassVar[List[str]] = ["is_on_anvil", "doi", "preview_timestamp", "release_timestamp", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "url", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "supersedes", "hashtag_barcode_map", "@id", "@type", "summary", "files", "control_for", "superseded_by", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "measurement_sets", "preferred_assay_titles", "preferred_assay_slims", "crispr_readout", "assay_titles", "assay_slims"]
