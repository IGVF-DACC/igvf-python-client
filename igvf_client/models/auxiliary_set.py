...
class AuxiliarySet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "url", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "supersedes", "barcode_map", "@id", "@type", "summary", "files", "control_for", "superseded_by", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "is_on_anvil", "measurement_sets", "preferred_assay_titles", "assay_titles"]
