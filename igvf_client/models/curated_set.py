...
class CuratedSet(BaseModel):
    ...
    def file_set_type_validate_enum(cls, value):
        ...
        if value not in set(['barcodes', 'editing templates', 'elements', 'external data for catalog', 'functional effect', 'genome', 'genes', 'guide RNAs', 'pipeline parameters', 'enrichment designs', 'QTL', 'training data for predictive models', 'transcriptome', 'variants']):
            raise ValueError("must be one of enum values ('barcodes', 'editing templates', 'elements', 'external data for catalog', 'functional effect', 'genome', 'genes', 'guide RNAs', 'pipeline parameters', 'enrichment designs', 'QTL', 'training data for predictive models', 'transcriptome', 'variants')")
        return value
