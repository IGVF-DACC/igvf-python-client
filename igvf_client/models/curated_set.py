...
class CuratedSet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "taxa", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "url", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "@id", "@type", "summary", "files", "control_for", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "assemblies", "transcriptome_annotations"]
    ...
    def file_set_type_validate_enum(cls, value):
        ...
        if value not in set(['barcodes', 'editing templates', 'elements', 'external data for catalog', 'genome', 'genes', 'guide RNAs', 'pipeline parameters', 'primer design', 'QTL', 'training data for predictive models', 'transcriptome', 'variants']):
            raise ValueError("must be one of enum values ('barcodes', 'editing templates', 'elements', 'external data for catalog', 'genome', 'genes', 'guide RNAs', 'pipeline parameters', 'primer design', 'QTL', 'training data for predictive models', 'transcriptome', 'variants')")
        return value
