...
class CrisprModification(BaseModel):
    ...
    def fused_domain_validate_enum(cls, value):
        ...
        if value not in set(['2xVP64', '2xVP64-2A-Puro', '2xVP64-2A-Thy1.1', '3xVP64', 'ABE8e', 'ABE8.20', 'ANTI-FLAG', 'BE4', 'BE4max', 'eA3A', 'eA3A-T31A', 'eA3A-T44D-S45A', 'KOX1-KRAB', 'M-MLV RT (PE2)', 'p300', 'TdCBE', 'TdCGBE', 'TdDE', 'Tet1', 'VPH', 'VP64', 'VP64-p65-Rta (VPR)', 'ZIM3-KRAB']):
            raise ValueError("must be one of enum values ('2xVP64', '2xVP64-2A-Puro', '2xVP64-2A-Thy1.1', '3xVP64', 'ABE8e', 'ABE8.20', 'ANTI-FLAG', 'BE4', 'BE4max', 'eA3A', 'eA3A-T31A', 'eA3A-T44D-S45A', 'KOX1-KRAB', 'M-MLV RT (PE2)', 'p300', 'TdCBE', 'TdCGBE', 'TdDE', 'Tet1', 'VPH', 'VP64', 'VP64-p65-Rta (VPR)', 'ZIM3-KRAB')")
        return value
