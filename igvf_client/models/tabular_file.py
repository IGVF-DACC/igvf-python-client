...
class TabularFile(BaseModel):
    ...
    primer_design_for: Optional[List[StrictStr]] = Field(default=None, description="Link(s) to the MeasurementSets using this file as a primer design.")
    __properties: ClassVar[List[str]] = ["base_modifications", "preview_timestamp", "cell_type_annotation", "controlled_access", "anvil_url", "assembly", "release_timestamp", "file_format_type", "transcriptome_annotation", "filtered", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "analysis_step_version", "content_md5sum", "content_type", "dbxrefs", "derived_from", "derived_manually", "file_format", "file_format_specifications", "file_set", "file_size", "md5sum", "submitted_file_name", "upload_status", "validation_error_detail", "checkfiles_version", "catalog_adapters", "@id", "@type", "summary", "integrated_in", "input_file_for", "gene_list_for", "loci_list_for", "quality_metrics", "assay_titles", "workflow", "href", "s3_uri", "upload_credentials", "barcode_map_for", "primer_design_for"]
    ...
    def base_modifications_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['4mC', '5hmC', '5mC', '6mA', 'inosine', 'm5C', 'm6A', 'pseudouridine']):
                raise ValueError("each list item must be one of ('4mC', '5hmC', '5mC', '6mA', 'inosine', 'm5C', 'm6A', 'pseudouridine')")
        return value
    ...
    def file_format_type_validate_enum(cls, value):
        ...
        if value not in set(['bed12', 'bed3', 'bed3+', 'bed5', 'bed6', 'bed6+', 'bed9', 'bed9+', 'mpra_starr', 'mpra_element', 'mpra_variant']):
            raise ValueError("must be one of enum values ('bed12', 'bed3', 'bed3+', 'bed5', 'bed6', 'bed6+', 'bed9', 'bed9+', 'mpra_starr', 'mpra_element', 'mpra_variant')")
        return value
    ...
    def file_format_validate_enum(cls, value):
        ...
        if value not in set(['bed', 'bedpe', 'csv', 'gtf', 'tsv', 'vcf']):
            raise ValueError("must be one of enum values ('bed', 'bedpe', 'csv', 'gtf', 'tsv', 'vcf')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "primer_design_for": obj.get("primer_design_for")
        })
        return _obj
