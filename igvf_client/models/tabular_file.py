...
class TabularFile(BaseModel):
    ...
    def file_format_validate_enum(cls, value):
        ...
        if value not in set(['bed', 'bedpe', 'bigBed', 'csv', 'gtf', 'tar', 'tsv', 'vcf']):
            raise ValueError("must be one of enum values ('bed', 'bedpe', 'bigBed', 'csv', 'gtf', 'tar', 'tsv', 'vcf')")
        return value
