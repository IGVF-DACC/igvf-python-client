...
class TabularFile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["anvil_url", "catalog_collections", "catalog_class", "catalog_notes", "base_modifications", "preview_timestamp", "cell_type_annotation", "controlled_access", "assembly", "release_timestamp", "file_format_type", "transcriptome_annotation", "reference_files", "filtered", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "analysis_step_version", "content_md5sum", "content_type", "dbxrefs", "derived_from", "derived_manually", "file_format", "file_format_specifications", "file_set", "file_size", "md5sum", "submitted_file_name", "upload_status", "validation_error_detail", "checkfiles_version", "supersedes", "catalog_adapters", "@id", "@type", "summary", "integrated_in", "input_file_for", "gene_list_for", "loci_list_for", "quality_metrics", "superseded_by", "assay_titles", "preferred_assay_titles", "workflows", "href", "s3_uri", "upload_credentials", "barcode_map_for", "primer_design_for"]
    ...
    def assembly_validate_enum(cls, value):
        ...
        if value not in set(['GRCh38', 'hg19', 'Cast - GRCm39', 'GRCm39', 'mm10', 'GRCh38, mm10', 'C57BL_6J_T2T_v1 + GRCm39_X', 'CAST_EiJ_T2T_v1', 'custom']):
            raise ValueError("must be one of enum values ('GRCh38', 'hg19', 'Cast - GRCm39', 'GRCm39', 'mm10', 'GRCh38, mm10', 'C57BL_6J_T2T_v1 + GRCm39_X', 'CAST_EiJ_T2T_v1', 'custom')")
        return value
