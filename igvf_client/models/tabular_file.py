...
class TabularFile(BaseModel):
    ...
    def assembly_validate_enum(cls, value):
        ...
        if value not in set(['GRCh38', 'hg19', 'Cast - GRCm39', 'GRCm39', 'mm10', 'GRCh38, GRCm39', 'GRCh38, mm10', 'C57BL_6J_T2T_v1 + GRCm39_X', 'CAST_EiJ_T2T_v1', 'custom']):
            raise ValueError("must be one of enum values ('GRCh38', 'hg19', 'Cast - GRCm39', 'GRCm39', 'mm10', 'GRCh38, GRCm39', 'GRCh38, mm10', 'C57BL_6J_T2T_v1 + GRCm39_X', 'CAST_EiJ_T2T_v1', 'custom')")
        return value
