...
class InVitroSystem(BaseModel):
    ...
    is_on_anvil: Optional[StrictBool] = Field(default=None, description="Indicates whether the sample has been submitted to AnVIL.")
