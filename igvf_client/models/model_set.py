...
class ModelSet(BaseModel):
    ...
    def file_set_type_validate_enum(cls, value):
        ...
        if value not in set(['decision tree', 'neural network', 'random forest', 'support vector machine', 'variant binding effect']):
            raise ValueError("must be one of enum values ('decision tree', 'neural network', 'random forest', 'support vector machine', 'variant binding effect')")
        return value
