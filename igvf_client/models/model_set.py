...
class ModelSet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["is_on_anvil", "doi", "preferred_assay_titles", "preview_timestamp", "input_file_sets", "release_timestamp", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "url", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "supersedes", "model_name", "model_version", "prediction_objects", "model_zoo_location", "assessed_genes", "external_input_data", "@id", "@type", "summary", "files", "control_for", "superseded_by", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "externally_hosted", "software_versions"]
