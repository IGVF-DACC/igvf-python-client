...
class PrimaryCell(BaseModel):
    ...
    def nucleic_acid_delivery_validate_enum(cls, value):
        ...
        if value not in set(['adenoviral transduction', 'lipofectamine', 'electroporation', 'lentiviral transduction', 'transfection']):
            raise ValueError("must be one of enum values ('adenoviral transduction', 'lipofectamine', 'electroporation', 'lentiviral transduction', 'transfection')")
        return value
