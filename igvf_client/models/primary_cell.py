...
class PrimaryCell(BaseModel):
    ...
    def construct_delivery_methods_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['adenoviral transduction', 'adeno-associated viral (AAV) transduction', 'lipofectamine', 'electroporation', 'lentiviral transduction', 'transfection', 'transformation', 'nucleofection']):
                raise ValueError("each list item must be one of ('adenoviral transduction', 'adeno-associated viral (AAV) transduction', 'lipofectamine', 'electroporation', 'lentiviral transduction', 'transfection', 'transformation', 'nucleofection')")
        return value
