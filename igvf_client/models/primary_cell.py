...
class PrimaryCell(BaseModel):
    ...
    def nucleic_acid_delivery_validate_enum(cls, value):
        ...
        if value not in set(['adenoviral transduction', 'adeno-associated viral (AAV) transduction', 'lipofectamine', 'electroporation', 'lentiviral transduction', 'transfection', 'transformation', 'nucleofection']):
            raise ValueError("must be one of enum values ('adenoviral transduction', 'adeno-associated viral (AAV) transduction', 'lipofectamine', 'electroporation', 'lentiviral transduction', 'transfection', 'transformation', 'nucleofection')")
        return value
    ...
    def biosample_qualifiers_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['6 days calcified', '10 days calcified', 'exhausted']):
                raise ValueError("each list item must be one of ('6 days calcified', '10 days calcified', 'exhausted')")
        return value
