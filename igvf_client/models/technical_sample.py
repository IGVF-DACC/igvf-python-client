...
class TechnicalSample(BaseModel):
    ...
    part_of: Optional[StrictStr] = Field(default=None, description="Links to technical sample which represents a larger sample from which this sample was taken.")
