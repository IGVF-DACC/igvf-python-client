...
class ModelFile(BaseModel):
    ...
    def file_format_validate_enum(cls, value):
        ...
        if value not in set(['hdf5', 'json', 'pkl', 'pt', 'tar', 'tsv']):
            raise ValueError("must be one of enum values ('hdf5', 'json', 'pkl', 'pt', 'tar', 'tsv')")
        return value
