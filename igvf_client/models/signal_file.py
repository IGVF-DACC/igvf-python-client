...
class SignalFile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "cell_type_annotation", "release_timestamp", "reference_files", "filtered", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "analysis_step_version", "content_md5sum", "content_type", "dbxrefs", "derived_from", "derived_manually", "file_format", "file_format_specifications", "file_set", "file_size", "md5sum", "submitted_file_name", "upload_status", "validation_error_detail", "checkfiles_version", "strand_specificity", "normalized", "start_view_position", "@id", "@type", "summary", "integrated_in", "input_file_for", "gene_list_for", "loci_list_for", "quality_metrics", "assay_titles", "preferred_assay_titles", "workflows", "href", "s3_uri", "upload_credentials", "content_summary", "transcriptome_annotation", "assembly"]
