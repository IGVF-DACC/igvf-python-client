...
class AnalysisSet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "input_file_sets", "release_timestamp", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "external_image_data_url", "demultiplexed_samples", "uniform_pipeline_status", "@id", "@type", "summary", "files", "control_for", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "preferred_assay_titles", "assay_titles", "protocols", "sample_summary", "functional_assay_mechanisms", "workflows", "targeted_genes"]
