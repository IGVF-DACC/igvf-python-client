...
class Treatment(BaseModel):
    ...
    def purpose_validate_enum(cls, value):
        ...
        if value not in set(['activation', 'agonist', 'antagonist', 'control', 'de-differentiation', 'differentiation', 'perturbation', 'selection', 'stimulation']):
            raise ValueError("must be one of enum values ('activation', 'agonist', 'antagonist', 'control', 'de-differentiation', 'differentiation', 'perturbation', 'selection', 'stimulation')")
        return value
