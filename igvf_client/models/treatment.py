...
class Treatment(BaseModel):
    ...
    def purpose_validate_enum(cls, value):
        ...
        if value not in set(['activation', 'acute activation', 'agonist', 'antagonist', 'chronic activation', 'control', 'de-differentiation', 'differentiation', 'perturbation', 'selection', 'stimulation']):
            raise ValueError("must be one of enum values ('activation', 'acute activation', 'agonist', 'antagonist', 'chronic activation', 'control', 'de-differentiation', 'differentiation', 'perturbation', 'selection', 'stimulation')")
        return value
    ...
    def treatment_type_validate_enum(cls, value):
        ...
        if value not in set(['chemical', 'protein', 'thermal']):
            raise ValueError("must be one of enum values ('chemical', 'protein', 'thermal')")
        return value
