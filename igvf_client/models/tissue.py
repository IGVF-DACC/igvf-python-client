...
class Tissue(BaseModel):
    ...
    ccf_id: Optional[StrictStr] = Field(default=None, description="HubMap Common Coordinate Framework unique identifier corresponding to the organ, biological structure, and spatial location of the tissue specimen within an organ.")
    ...
    def nucleic_acid_delivery_validate_enum(cls, value):
        ...
        if value not in set(['adenoviral transduction', 'lipofectamine', 'electroporation', 'lentiviral transduction', 'transfection', 'transformation', 'nucleofection']):
            raise ValueError("must be one of enum values ('adenoviral transduction', 'lipofectamine', 'electroporation', 'lentiviral transduction', 'transfection', 'transformation', 'nucleofection')")
        return value
