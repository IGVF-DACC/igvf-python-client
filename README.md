...
The Python client is autogenerated based on this [IGVF OpenAPI specification](https://github.com/IGVF-DACC/igvf-client-openapi-spec/blob/main/openapi_spec.json). It exposes `search`, `collection`, and other read endpoints from the [IGVF Data Portal](https://data.igvf.org).
